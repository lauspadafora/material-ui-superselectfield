...
export function areEqual (val1, val2) {
  ...
  ) { return false; } else if (typeof val1 === 'string' || typeof val1 === 'number' || typeof val1 === 'boolean') return val1 === val2;
...
export function getChildrenLength (children) {
  if (!children) return 0;
    ...
    return children.reduce(function (count, _ref2) {
      ...
      const _ref2$props = _ref2.props;
      const value = _ref2$props.value;
      const cpc = _ref2$props.children;
